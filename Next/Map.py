...
class Map(object):
    ...
    #Map class contains every map object such as tiles, mobs and player including camera, event and UI.
    ...
    def spawn_score_text(self, x, y, score=None):
        ...
        # Score that shows after killing enemy
        if score is None:
